        ...
        <Card className="border border-slate-200/60 shadow-sm">
          <CardContent className="p-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link href="/team-leader/lead-management/leads" className="flex items-center gap-2 p-3 border border-slate-200/60 rounded-lg hover:bg-slate-50 hover:border-primary/30 transition-all text-xs font-medium text-slate-700 hover:text-primary">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
                Add Lead
              </Link>
              <Link href="/team-leader/lead-management/tasks" className="flex items-center gap-2 p-3 border border-slate-200/60 rounded-lg hover:bg-slate-50 hover:border-primary/30 transition-all text-xs font-medium text-slate-700 hover:text-primary">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
                Assign Tasks
              </Link>
              <Link href="/team-leader/lead-management/queue" className="flex items-center gap-2 p-3 border border-slate-200/60 rounded-lg hover:bg-slate-50 hover:border-primary/30 transition-all text-xs font-medium text-slate-700 hover:text-primary">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                View Queue
              </Link>
              <Link href="/team-leader/lead-management/analytics" className="flex items-center gap-2 p-3 border border-slate-200/60 rounded-lg hover:bg-slate-50 hover:border-primary/30 transition-all text-xs font-medium text-slate-700 hover:text-primary">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 00-2 2z" />
                </svg>
                Analytics
